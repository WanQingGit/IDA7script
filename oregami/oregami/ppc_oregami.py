...
_op_details_l = {}
_op_details_l[('cmpi',3)] = ([1],[])    # e_cmpi    cr0, r4, -1
_op_details_l[('cmpi',2)] = ([0],[])    # se_cmpi   r4, 0
_op_details_l[('mtctr',1)] = ([0],[])
_op_details_l[('mtlr',1)] = ([0],[])
_op_details_l[('addi',3)] = ([0,1],[0]) # e_addi    r8, r4, 0x1E
_op_details_l[('addi',2)] = ([0],[0])   # se_addi   r1, 0x10
_op_details_l[('add',2)] = ([0],[0])    # se_add    r5, r0
_op_details_l[('add',3)] = ([0,1],[0])  # add       r4, r7, r8
_op_details_l[('subi',3)] = ([0,1],[0])
_op_details_l[('subi',2)] = ([0],[0])
_op_details_l[('subf',2)] = ([0,1],[0])
_op_details_l[('slwi',3)] = ([0,1],[0])       # e_slwi    r6, r5, 2
_op_details_l[('slwi',2)] = ([0],[0])       # se_slwi   r5, 4
_op_details_l[('srwi',3)] = ([0,1],[0])
_op_details_l[('srwi',2)] = ([0],[0])
_op_details_l[('cmpli',2)] = ([0],[])   # se_cmpli r27, 4
_op_details_l[('cmpli',3)] = ([1],[])   # e_cmpli   cr0, r31, 0xA0000000
